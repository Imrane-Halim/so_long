...
/*   Updated: 2024/12/15 15:01:14 by ihalim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->enemy.frames[0] = create_img(data, "enemy_animation_xpm/enemy_frame_1.xpm");
	data->enemy.frames[1] = create_img(data, "enemy_animation_xpm/enemy_frame_2.xpm");
}
